...
def update_hand(hand, word):
    ...
    for w in word.lower():
        hand_clone[w] = hand_clone.get(w, 0) - 1
        if hand_clone[w] <= 0:
            del hand_clone[w]
    return hand_clone
#
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    for i in range(num_hands):
        ...
        print('Total score for this hand: {}'.format(score1))
        
        print('-------------')
        ans = input('Would you like to replay the hand? ')
        if ans.lower() in ['yes', 'y']:
            score2 = play_hand(hand, word_list)
            score_hand = max(score1, score2)
        else:
            score_hand = score1

        print('Total score for this hand: {}'.format(score_hand))
        
        total += score_hand
        
    print('\n##########\nTotal score over all hands: {}'.format(total))
